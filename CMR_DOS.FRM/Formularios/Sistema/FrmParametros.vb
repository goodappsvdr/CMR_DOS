        ...
        Try
            ...
            Select Case Me.Estado
                ...
                Case FormEstado.eAgregar
                    ...
                    resultado = oObjeto.Agregar(TxtCategoria.Text, _
                                                TxtNombre.Text, _
                                                TxtValor.Text, _
...
#Region "Botones de Comando"
    ...
    Private Sub ItemExcel_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles CmdExportar.Click
        ...
        exporter.SheetName = "Parametros"
        exporter.SummariesExportOption = SummariesOption.DoNotExport

        Dim fileName As String = Application.StartupPath & "\Parametros.xls"
        exporter.RunExport(fileName)

        Process.Start(Application.StartupPath & "\Parametros.xls")
...
#Region "Funciones Propias"
    ...
    Private Function Validar() As Boolean
        ...
        If TxtValor.Text = "" Or TxtNombre.Text = "" Or TxtCategoria.Text = "" Then

            MsgBox("Ingrese los datos...", MsgBoxStyle.Exclamation, G_AppName)
            Validar = False
            Exit Function
    ...
    Public Function BuscarPorID(ByVal ID As Integer) As Boolean
        ...
        If oDs.Tables(0).Rows.Count > 0 Then
            ...
            TxtCategoria.Text = LTrim(RTrim(oDs.Tables(0).Rows(0).Item("Categoria")))
            TxtNombre.Text = LTrim(RTrim(oDs.Tables(0).Rows(0).Item("Nombre")))
            TxtValor.Text = LTrim(RTrim(oDs.Tables(0).Rows(0).Item("Valor")))
...
#End Region
    ...
    Private Sub txtOrden_TextChanged(sender As System.Object, e As System.EventArgs) Handles txtDescripcion.TextChanged
