        ...
        Try
            ...
            Select Case Me.Estado
                ...
                Case FormEstado.eAgregar
                    ...
                    resultado = oObjeto.Agregar(TxtNombre.Text, _
                                                TxtIdPadre.Text, _
                                                TxtFormulario.Text, _
                                                TxtDescripcion.Text, _
                                                checkVisible.Checked, _
                                                txtOrden.Text, _
...
#Region "Botones de Comando"
    ...
    Private Sub ItemExcel_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles CmdExportar.Click
        ...
        exporter.SheetName = "Menu"
        exporter.SummariesExportOption = SummariesOption.DoNotExport

        Dim fileName As String = Application.StartupPath & "\Menu.xls"
        exporter.RunExport(fileName)

        Process.Start(Application.StartupPath & "\Menu.xls")
...
#Region "Funciones Propias"
    ...
    Public Function BuscarPorID(ByVal ID As Integer) As Boolean
        ...
        If oDs.Tables(0).Rows.Count > 0 Then
            ...
            TxtIdPadre.Text = LTrim(RTrim(oDs.Tables(0).Rows(0).Item("ID_Padre")))
            TxtFormulario.Text = LTrim(RTrim(oDs.Tables(0).Rows(0).Item("Formulario")))
            TxtDescripcion.Text = LTrim(RTrim(oDs.Tables(0).Rows(0).Item("Descripcion")))
            txtOrden.Text = LTrim(RTrim(oDs.Tables(0).Rows(0).Item("Orden")))
            checkVisible.Checked = oDs.Tables(0).Rows(0).Item("ShowinMenu")
            EstadosCtrl1.SelectedValue = oDs.Tables(0).Rows(0).Item("Estado")
