...
#Region "Procedimientos Propios"
    ...
    Public Sub LimpiarDatos()
        ...
        TxtNombre.Text = ""
        TxtCodigo.Text = ""
        EstadosCtrl1.Iniciar("SECCIONESTIPO")
    ...
    Private Sub Acepto()
        ...
        Dim oResoluciones As New Resoluciones
        Dim oMotivos As New Motivos
...
#Region "Formulario"
    ...
    Private Sub FrmSeccionesTipo_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles Me.KeyDown
    ...
    Private Sub FrmSeccionesTipo_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles Me.KeyPress
    ...
    Private Sub FrmSeccionesTipo_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Me.Load
...
#Region "Funciones Propias"
    ...
    Private Function Validar() As Boolean
        ...
        If TxtNombre.Text = "" Or TxtCodigo.Text = "" Then

            MsgBox("Complete sus datos...", MsgBoxStyle.Exclamation, G_AppName)
            Validar = False
            Exit Function
        ElseIf verificarCodigo(TxtCodigo.Text, SeccionesCtrl1.SelectedValue) Then
    ...
    Public Function BuscarPorID(ByVal ID As Integer) As Boolean
        ...
        If oDs.Tables(0).Rows.Count > 0 Then
            ...
            TxtCodigo.Text = LTrim(RTrim(oDs.Tables(0).Rows(0).Item("Codigo")))
...
#End Region
    ...
    Private Function verificarCodigo(codigo As String, seccion As Double) As Boolean
        Dim ods As New DataSet
        Dim oObjeto As New SeccionesTipo
        ods = oObjeto.BuscarPorcodigo(codigo, seccion)
        If ods.Tables(0).Rows.Count > 0 Then
            Return True
        Else
            Return False
    ...
    Private Function verificarNombre(Nombre As String, seccion As Double) As Boolean
        Dim ods As New DataSet
        Dim oObjeto As New SeccionesTipo
        ods = oObjeto.SeccionesTipo_ValidarNombre(Nombre, seccion)
        If ods.Tables(0).Rows.Count > 0 Then
            Return True
        Else
            Return False
