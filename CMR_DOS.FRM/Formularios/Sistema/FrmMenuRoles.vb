        ...
        Try
            ...
            Select Case Me.Estado
                ...
                Case FormEstado.eAgregar
                    ...
                    resultado = oObjeto.Agregar(MenusCtrl1.SelectedValue, _
                                                RolesCtrl1.SelectedValue, _
                                                CheckAcceso.Checked, _
...
#Region "Formulario"
    ...
    Private Sub FrmMenuRoles_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles Me.KeyDown
    ...
    Private Sub FrmMenuRoles_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles Me.KeyPress
    ...
    Private Sub FrmMenuRoles_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Me.Load
...
#Region "Botones de Comando"
    ...
    Private Sub ItemExcel_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles CmdExportar.Click
        ...
        exporter.SheetName = "MenuRoles"
        exporter.SummariesExportOption = SummariesOption.DoNotExport

        Dim fileName As String = Application.StartupPath & "\MenuRoles.xls"
        exporter.RunExport(fileName)

        Process.Start(Application.StartupPath & "\MenuRoles.xls")
...
#Region "Funciones Propias"
    ...
    Public Function BuscarPorID(ByVal ID As Integer) As Boolean
        ...
        If oDs.Tables(0).Rows.Count > 0 Then
            ...
            MenusCtrl1.SelectedValue = oDs.Tables(0).Rows(0).Item("ID_Menu")
            RolesCtrl1.SelectedValue = oDs.Tables(0).Rows(0).Item("ID_Rol")
            CheckAcceso.Checked = oDs.Tables(0).Rows(0).Item("acceso")
