...
#Region "Procedimientos Propios"
    ...
    Public Sub LimpiarDatos()
        ...
        TxtNombre.Text = ""
        TxtCodigo.Text = ""
        EstadosCtrl1.Iniciar("SECCIONES")
...
#Region "Formulario"
    ...
    Private Sub FrmSecciones_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles Me.KeyDown
    ...
    Private Sub FrmSecciones_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles Me.KeyPress
    ...
    Private Sub FrmSecciones_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Me.Load
...
#End Region
    ...
    'Private Function verificarCodigo(codigo As String) As Boolean
    '    Dim ods As New DataSet
    '    Dim oObjeto As New Secciones
    '    ods = oObjeto.BuscarPorcodigo(codigo)
    '    If ods.Tables(0).Rows.Count >= 0 Then
    '        Return True
    '    Else
    '        Return False
    ...
    'End Function
    'Private Function verificarDescripcionSeccion(Descripcion As String) As Boolean
    '    Dim ods As New DataSet
    '    Dim oObjeto As New Secciones
    '    ods = oObjeto.BuscarPorcodigo(Descripcion)
    '    If ods.Tables(0).Rows.Count >= 0 Then
    '        Return False
    '    Else
    '        Return True
