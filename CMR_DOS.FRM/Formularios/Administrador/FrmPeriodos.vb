        ...
        Try
            ...
            Select Case Me.Estado
                ...
                Case FormEstado.eAgregar
                    ...
                    resultado = oObjeto.Agregar(txtNombre.Text, FechaDesde.Value, FechaHasta.Value)
...
#Region "Funciones Propias"
    ...
    Public Function BuscarPorID(ByVal ID As Integer) As Boolean
        ...
        If oDs.Tables(0).Rows.Count > 0 Then
            ...
            FechaDesde.Value = LTrim(RTrim(oDs.Tables(0).Rows(0).Item("fechadesde")))
            FechaHasta.Value = oDs.Tables(0).Rows(0).Item("fechahasta")
