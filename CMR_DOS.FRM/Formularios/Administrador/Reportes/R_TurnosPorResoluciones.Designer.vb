Partial Class R_TurnosPorResoluciones
    ...
    "Str(Parameters.fechahasta.Value),0,10)" & Global.Microsoft.VisualBasic.ChrW(13) & Global.Microsoft.VisualBasic.ChrW(10)
        ...
        Me.SqlDataSource1.Parameters.AddRange(New Telerik.Reporting.SqlDataSourceParameter() {New Telerik.Reporting.SqlDataSourceParameter("@id_Resolucion", System.Data.DbType.Int32, "=Parameters.idResolucion.Value"), New Telerik.Reporting.SqlDataSourceParameter("@fechadesde", System.Data.DbType.[Date], "=Parameters.fechadesde.Value"), New Telerik.Reporting.SqlDataSourceParameter("@fechahasta", System.Data.DbType.[Date], "=Parameters.fechahasta.Value"), New Telerik.Reporting.SqlDataSourceParameter("@id_estado", System.Data.DbType.Int32, "=Parameters.idestado.Value")})
