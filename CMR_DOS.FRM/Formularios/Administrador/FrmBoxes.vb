...
#Region "Botones de Comando"
    ...
    Private Sub ItemExcel_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles CmdExportar.Click
        ...
        exporter.SheetName = "Boxes"
        exporter.SummariesExportOption = SummariesOption.DoNotExport

        Dim fileName As String = Application.StartupPath & "\Boxes.xls"
        exporter.RunExport(fileName)

        Process.Start(Application.StartupPath & "\Boxes.xls")
...
#Region "Funciones Propias"
    ...
    Private Function Validar() As Boolean
        ...
        If txtCodigo.Text = "" Or txtNroBox.Text = "" Then

            MsgBox("Complete sus datos...", MsgBoxStyle.Exclamation, G_AppName)
            Validar = False
            Exit Function

        ElseIf IsNumeric(txtNroBox.Text) = False Then
            Validar = False
            MsgBox("Sólo puede ingresar valores numericos como numero de box...", MsgBoxStyle.Exclamation, G_AppName)
        ...
        'ods = obox.Box_Verificar(txtCodigo.Text, txtNroBox.Text)
        'Dim IdBox As String
        'IdBox = TxtID.Text
        'Dim valor As String = Convert.ToString(ods.Tables(0).Rows.Item("id_box"))
        'If valor <= 0 Then
        ...
        'Else
        '    Validar = False
        '    MsgBox("Este box ya existe!...", MsgBoxStyle.Exclamation, G_AppName)
        '    Exit Function
        'End If
