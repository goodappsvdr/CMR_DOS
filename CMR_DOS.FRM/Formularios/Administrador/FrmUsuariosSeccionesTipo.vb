...
Public Class FrmUsuariosSeccionesTipo
        ...
        Try
            ...
            Select Case Me.Estado
                ...
                Case FormEstado.eAgregar
                    ...
                    resultado = oObjeto.Agregar(SeccionesTipoCtrl1.SelectedValue, _
                                                UsuariosCtrl1.SelectedValue, _
                                                EstadosCtrl1.SelectedValue, _
...
#Region "Botones de Comando"
    ...
    Private Sub CmdModificar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles CmdModificar.Click
        aux = SeccionesTipoCtrl1.SelectedValue
    ...
    Private Sub ItemExcel_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles CmdExportar.Click
        ...
        exporter.SheetName = "UsuariosSubSecciones"
        exporter.SummariesExportOption = SummariesOption.DoNotExport

        Dim fileName As String = Application.StartupPath & "\UsuariosSubSecciones.xls"
        exporter.RunExport(fileName)

        Process.Start(Application.StartupPath & "\UsuariosSubSecciones.xls")
...
#Region "Funciones Propias"
    ...
    Private Function Validar() As Boolean
        ...
        If SeccionesTipoCtrl1.SelectedValue = aux Then
            Validar = True
            Exit Function
        Else
