...
Public Class Parametros
    ...
    Public Function BuscarPorCategoria(ByVal Categoria As String) As DataSet
        ...
        Try
            ...
            Return oDatabase.ExecuteDataSet("Parametros_BuscarTodosPorCategoria", Categoria)
    ...
    'Insert
    Public Function Agregar(ByVal Categoria As String, ByVal Nombre As String, ByVal Valor As String, ByVal Descripcion As String, ByVal Orden As Double, ByVal Activo As Boolean) As Double

        Try

            Return oDatabase.ExecuteScalar("Parametros_Agregar", Categoria, Nombre, Valor, Descripcion, Orden, Activo)
    ...
    Public Function Modificar(ByVal Id_parametro As Double, ByVal Categoria As String, ByVal Nombre As String, ByVal Valor As String, ByVal Descripcion As String, ByVal Orden As Double, ByVal Activo As Boolean) As DataSet

        Try

            Return oDatabase.ExecuteDataSet("Parametros_Modificar", Id_parametro, Categoria, Nombre, Valor, Descripcion, Orden, Activo)
